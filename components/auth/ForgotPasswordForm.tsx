...
export function ForgotPasswordForm({
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-background">
      ...
      <Image src="/JF.avif" alt="" aria-hidden width={448} height={448} className="pointer-events-none absolute -right-16 top-10 hidden w-[28rem] max-w-none opacity-[0.04] lg:block" />
