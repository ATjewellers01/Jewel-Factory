...
>(({ className, value, defaultValue, ...props }, ref) => {
  // Render one thumb per value so this also works as a dual-handle range
  // slider (value={[min, max]}) — the original only ever rendered a single
  // hardcoded Thumb, which silently broke range selection.
